...
var countDownDate = new Date("March 4, 2020 09:00:00").getTime();
...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("countdown").innerHTML = '<div class="col text-center mb-3"><h3>Happenning Now</h3></div>';
    }
}, 1000);
